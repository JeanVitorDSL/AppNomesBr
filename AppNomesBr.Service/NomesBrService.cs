...
namespace AppNomesBr.Service
{
    public class NomesBrService : INomesBrService
    {
        ...
        public async Task<RankingNomesRoot[]> ListaRanking(string cidade = null, string sexo = null)
        {
            try
            {
                logger.LogInformation("Consultando ranking de nomes com filtros");
                ...
                if (rankingNomesRoot == null)
                    throw new InvalidDataException("Nenhum resultado encontrado.");
        ...
        public async Task InserirNovoRegistroNoRanking(string nome, string sexo = null)
        {
            try
            {
                ...
                var result = await ibgeNomesApiService.RetornaCensosNomesPeriodo(nome, sexo);
